        ...
        <Link to={`/blog/${blog.id}`}>
          <div className="w-[350px] h-[full] rounded overflow-hidden shadow-lg bg-white">
            ...
            <div className="px-6 py-4">
              ...
              <p className="text-gray-700 text-[18px]">{blog.links}</p>
            </div>
            <div className="px-6 py-4 flex items-center justify-between">
              ...
              <button className="outline-none bg-black text-white text-[14px] font-semibold rounded-lg p-2  cursor-pointer  ">
                View Blog
              </button>
            </div>
          </div>
